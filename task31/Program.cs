...
PrintArray(arr);
int[] getSumPositivNegativeElem = GetSumPositiveNegativeElem(arr);
Console.WriteLine($"Сумма положительный элементов =  {getSumPositivNegativeElem[0]}");
Console.WriteLine($"Сумма отрицательных элементов =  {getSumPositivNegativeElem[1]}");
